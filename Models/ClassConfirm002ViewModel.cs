...
{
    /// <summary>
    /// Classconfirm002 自辦在職進修/課程錄訓名單查詢 ViewModel
    /// </summary>
    public class ClassConfirm002ViewModel
    {
        /// <summary>
        /// 建構子
        /// </summary>
        public ClassConfirm002ViewModel()
        {
            this.Form= new ClassConfirm002FormModel();
        }

        /// <summary>
        /// 查詢條件 FormModel
        /// </summary>
        public ClassConfirm002FormModel Form { get; set; }

        /// <summary>
        /// 查詢結果 GridModel
        /// </summary>
        public IList<ClassConfirm002GridModel> Grid { get; set; }

        /// <summary>
        /// 單位課程查詢條件
        /// </summary>
        public ClassConfirm002ClassFormModel ClassForm { get; set; }

        /// <summary>
        /// 學生查詢結果
        /// </summary>
        public ClassConfirm002DetailModel Detail { get; set; }
    ...
    /// 查詢條件
    /// </summary>
    public class ClassConfirm002FormModel: PagingResultsViewModel
    {
        //格式檢核(檢核是不是數字)
    ...
    /// 查詢結果
    /// </summary>
    public class ClassConfirm002GridModel
    {
        /// <summary>
        /// ?
        /// </summary>
    ...
    /// 單位課程查詢條件
    /// </summary>
    public class ClassConfirm002ClassFormModel: PagingResultsViewModel
    {
        /// <summary>
        /// 班別代碼
        /// </summary>
    ...
    /// 學生查詢結果
    /// </summary>
    public class ClassConfirm002DetailModel
    {
        /// <summary>
        /// 班別代碼
        /// </summary>
        ...
        /// 學生名單資料
        /// </summary>
        public IList<ClassConfirm002StudGridModel> UserGrid { get; set; }
    }

    /// <summary>
    /// 學生清單資料
    /// </summary>
    public class ClassConfirm002StudGridModel
    {
        /// <summary>
        /// 班別代碼
        /// </summary>
