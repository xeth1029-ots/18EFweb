...
{
    public class ClassConfirm002Controller : BaseController
    {
        // GET: ClassConfirm002        
        public ActionResult Index()
        {
            SessionModel sm = SessionModel.Get();
            ClassConfirm002ViewModel model = new ClassConfirm002ViewModel();
        ...
        [HttpPost]
        [SecurityFilter]
        public ActionResult Index(ClassConfirm002FormModel form)
        {
            ClassConfirm002ViewModel model = new ClassConfirm002ViewModel();
            model.Form = form;
        ...
        [HttpPost]
        public ActionResult Detail(ClassConfirm002ClassFormModel form)
        {
            ClassConfirm002ViewModel model = new ClassConfirm002ViewModel();
        ...
        public void ValidFormInput(ClassConfirm002FormModel model)
        {
